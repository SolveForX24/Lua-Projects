...
return { calculateTotalReturn = calculateTotalReturn, calculateSavingRateReturn = calculateSavingRateReturn, calculateSavingsPerYearReturn = calculateSavingsPerYearReturn, printSavingsStatement = printSavingsStatement, wait = wait }
